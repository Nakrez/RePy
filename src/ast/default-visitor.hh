...
namespace ast
{
    ...
    class GenDefaultVisitor : public virtual GenVisitor<Const>
    {
        public:
            ...
            virtual void operator()(typename Const<ClassDec>::type& ast);
            virtual void operator()(typename Const<ModuleStmt>::type& ast);
            ...
            virtual void operator()(typename Const<MethodVar>::type& ast);
    };
